...
//intelligent browser start 
   ...
   /*if(m_tabWidget->count()<5)  //브라우저 시작 시 탭 생성	//{H}hiddentab number
   {
...
//{H} calulate to go home count
//connect(m_stopReload, SIGNAL(triggered()), this, SLOT(increaseHomeCount()));
...
//{H} Simulate to go to homepage
/*void BrowserMainWindow::increaseHomeCount()
{ 
	goHomePageCount++;
}*/
